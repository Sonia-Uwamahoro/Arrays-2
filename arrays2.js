...
// Given an array of unsorted numbers, return the index of the following target if the target exists 
// in the array. If the target is not found, return null
...
console.log("The Index of element 6 is: ",targetIndex);
